...
game_finished = False
# What was the point of putting the game_finished = False? <- edit: I later realized it was a set-up of 
# the game_finished variable
...
# How about putting values in brackets?
...
print(Score)
# How about printing a statement with the score to declare the player's final score?